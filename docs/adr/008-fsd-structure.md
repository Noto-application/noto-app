...
- ESLint-правила на соблюдение границ FSD (плагин или custom rules)
- Минимум кастомных стилей по месту — через `shared/ui` (shadcn)

## Альтернативы

| Вариант | Почему отклонён |
|---------|-----------------|
| Плоская структура `components/` | Плохо масштабируется в команде |
| Полный FSD с первого дня | Замедляет старт обучающей команды |
