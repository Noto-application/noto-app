...
- [ ] Что считаем «первым релизом» для GitHub / demo?
- [ ] Collaborative editing — в MVP или Phase 2?
- [ ] SEO-статьи — обязательны в v1?
- [ ] ИИ — demo-фича или откладываем?
...
2. Зафиксировать в ADR-010 (MVP scope)
