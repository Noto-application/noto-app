...
**Статус:** Superseded by [ADR-016](../adr/016-e2e-testing.md)
**Дата:** 2026-07-20
**Обновлён:** 2026-08-11

> Решение (Playwright) принято и вынесено в [ADR-016](../adr/016-e2e-testing.md).
> Этот RFC оставлен как история проработки (контекст, альтернативы, сценарии).
