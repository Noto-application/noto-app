...
**Статус:** Superseded by [ADR-015](../adr/015-rich-text-editor.md)
**Дата:** 2026-07-20
**Обновлён:** 2026-08-11

> Решение (BlockNote) принято и вынесено в [ADR-015](../adr/015-rich-text-editor.md).
> Этот RFC оставлен как история проработки (контекст, альтернативы, критерии).
