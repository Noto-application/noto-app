...
| ID                                      | Название                                        | Статус              |
| --------------------------------------- | ----------------------------------------------- | ------------------- |
| [001](./001-api-contract.md)            | Контракт API: REST + ts-rest + shared contracts | Направление принято |
| [002](./002-rich-text-editor.md)        | Rich-text редактор                              | Accepted            |
...
| [009](./009-responsive-strategy.md)     | Адаптивность / responsive-стратегия             | Draft               |
