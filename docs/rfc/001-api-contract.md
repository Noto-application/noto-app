...
**Статус:** Superseded by [ADR-012](../adr/012-api-contract.md)
**Дата:** 2026-07-20
**Обновлён:** 2026-08-10

> Решение принято и вынесено в [ADR-012](../adr/012-api-contract.md). Этот RFC
> оставлен как история проработки (контекст, альтернативы).
